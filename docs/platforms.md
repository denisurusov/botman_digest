...
- **Llama 4 Security Update** — New zero-day prompt injection vulnerability (CVE-2026-0345) allowing model inversion attacks disclosed; affects 70% of fine-tuned deployments. Patch released by Meta.
