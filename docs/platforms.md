...
- **Mistral Large 2** — 500B param model with enhanced long-context (2M tokens) and agentic capabilities. Beats GPT-4o on MMLU (88.5%). Open weights on Hugging Face. API now live.
