...
*(Covering developments from 2026-03-16 00:00 UTC to 2026-03-17 23:59 UTC. Prioritizing model releases, papers, and open-source projects. Sourced from web searches on major outlets like TechCrunch, arXiv, GitHub, and X/Twitter.)*
